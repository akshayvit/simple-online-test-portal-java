...
public class OnlineTest extends JFrame implements ActionListener
{
	...
	OnlineTest(String s)
	{
		...
		setLocation(250,100);
                             ...
                             JLabel background=new JLabel(new ImageIcon("C:\\Users\\Public\\Pictures\\Sample Pictures\\Desert.jpg"));
                          add(background);
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==b1)
		{
                                            if(al.get(current)!=-1){ System.out.println(al.get(current));jb[al.get(current)].setSelected(true); }
                                             else{for(int i=0;i<5;i++)
                                              {
                                                        if(jb[i].isSelected()){ al.set(current,i); }
                                               }
			...
			if(current==9)
			{
				...
				b2.setText("Result");
                              ...
                              { 
                                       ...
                                       current--;
                                        set();
                                        if(current==0){ b3.setEnabled(false); }  
                                        jb[al.get(current)].setSelected(true);
                              }
	...
	{
		new OnlineTest("Online Test Portal");
	}
}